 ...
 * @author Ahmed
 */
public class SortCoachRating extends javax.swing.JFrame {

    /**
     * Creates new form AddCoachRecords
     */
    public SortCoachRating() {
        initComponents();
        BufferedReader fr;
        FileWriter fw;
        Sort Asc = new Sort();
        try {
            ...
            fr.close();
            str.sort(Comparator.comparing(r -> Asc.getSortRating(r)));
    ...
    private void initComponents() {
        ...
        Title1.setText("Coach Records (Rating Ascending):");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SortCoachRating().setVisible(true);
            }
        });
    }
