 ...
 * @author Ahmed
 */
public class AddRecScreen extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Title.setText("Select Records To Add");
        ...
        Sport.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        Sport.setText("Sport");
        ...
        Schedule.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        Schedule.setText("Sport Schedule");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(Schedule, javax.swing.GroupLayout.DEFAULT_SIZE, 168, Short.MAX_VALUE)
    ...
    private void CoachActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CoachActionPerformed
        this.setVisible(false);
        AddCoachRecords a = new AddCoachRecords();
        a.setVisible(true);
    ...
    private void SportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SportActionPerformed
        this.setVisible(false);
        AddSportsRecords a = new AddSportsRecords();
        a.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddRecScreen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddRecScreen().setVisible(true);
            }
        });
    }
